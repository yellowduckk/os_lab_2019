...
int main(int argc, char **argv) {
            ...
            case 0:
                switch (option_index) {
                    case 0:
                        ...
                        if(seed<=0)
                        {
                            printf("ERROR!!! Seed is negative number\n");
                            return 1;
                        }
                    ...
                    case 1:
                        ...
                        if (array_size<=0)
                        {
                            printf("ERROR!!! Array_size is negative number\n");
                            return 1;
                        }
                        break;
                    case 2:
                        ...
                        if(pnum<=0)
                        {
                            printf("ERROR!!! Pnum is negative number\n");
                            return 1;
                        }
                        break;
                    case 3: //добавили кейс со временем
                        if (optarg) {
                            timeout = atoi(optarg);
                            if (timeout <= 0) {
                                printf("ERROR!!! timeout is negative number\n");
                                return 1;
                             }
                        }
                        break;
    ...
    double elapsed_time = (finish_time.tv_sec - start_time.tv_sec) * 1000.0;// перенесли
